...
public class ProductController {
	...
	public ResponseEntity<Product> postProduct(@RequestBody Product product) {
		try {
			Product _product = repository.save(new Product(product.getName(), product.getCategory() , product.getPrice(), product.getManufacture(),product.getUnitInStock(),product.getDescription()));
	...
	public ResponseEntity<Product> updateProduct(@PathVariable("id") int id, @RequestBody Product product) {
		...
		if (productData.isPresent()) {
			...
			_product.setManufacture(product.getManufacture());
